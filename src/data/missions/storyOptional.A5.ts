...
export const OPTIONAL_MISSIONS_A5: Mission[] = [
    ...
    },
    {
        ...
        dispatchRecommended: ["Viera White Mage"],
        objective: "Dispatch the right person for the job!",
        requiredTalents: {
            negotiation: 28,
            aptitude: 0,
    ...
    },
    {
        ...
        canCancel: true,
        members: 6,
        prerequisite: "Pearls in the Deep; Black King of Cinquleur; visit Graszton",
        requiredTalents: {
            negotiation: 0,
            aptitude: 0,
            teamwork: 11,
    ...
    },
    {
        ...
        arc: "A5",
        name: "The Five Kings",
        description: "We of Cinquleur seek battle with Clan Gully! Cinquleur",
        rank: 99,
        region: "The Aldanna Range",
        fee: 500,
        days: 20,
        ...
        law: "Forbidden: < 200 HP - Having less than 200 HP is forbidden.",
    enemies: [
        { name: "Red King Ruuj", job: "Red Mage", quantity: 1, notes: "Level 99. Doublecast and Red Magick pressure." },
