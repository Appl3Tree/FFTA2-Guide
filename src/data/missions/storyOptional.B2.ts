...
export const OPTIONAL_MISSIONS_B2: Mission[] = [
    {
        ...
        arc: "B2",
        name: "Wanted: Ugohr",
        description: "-WANTED!- Wanted: Ugohr, a green-colored shelling, last spotted on Baptiste Hill. One reported case of injury arising from contact with said beast. Payment to be made by injured party. -Jylland Defenders of the Peace",
        rank: 8,
    ...
    },
    {
        ...
        arc: "B2",
        name: "Throw Down",
        description: "Clan Gully, We are in pursuit of an infamous monster that promises to be quite a handful... Would you aid us in driving this menace away? -Bowen of House Bowen",
        rank: 14,
        region: "Baptiste Hill",
        fee: 300,
        days: 20,
    ...
    },
    {
        ...
        description: "A local watch hired us to set traps to help them deal with their monster problem. Unfortunately, I set my traps in the wrong place. If word of my mistake gets out, I'll be in serious trouble. That's why I need someone to destroy the traps for me without causing a big stir. -Esther, New Hire",
        rank: 33,
    ...
    enemies: [
        ...
        strategy: [           "Yellow traps Silence, green traps deal 10 HP damage, blue traps halve current HP, and purple traps Charm; avoid all-unit targeting because of the law.",
        ],
        rewards: {
            gil: 4830,
            cp: 66,
    ...
    },
    {
        ...
        description: "-WANTED!- Wanted: Gilmunto, possibly a variant strain of nidhogg, known to lurk in the foothills of the Aldanna Range. Vicious and violent, should be considered dangerous in the extreme! Those without faith in their sword arm, give this one wide berth. -Jylland Defenders of the Peace",
        rank: 12,
        region: "The Aldanna Range",
        fee: 300,
        days: undefined,
    ...
    },
    {
        ...
        arc: "B2",
        name: "It's a Trap!",
        description: "While traveling through the Aldanna Range I mistakenly dropped several traps meant for sale. I'm afraid the shock of the drop has likely released their safety mechanisms, making them quite dangerous! Deactivating them would be hazardous at this point, so I just need someone to destroy them. It's the only way to be sure. -Esther, New Hire",
        rank: 23,
        region: "The Aldanna Range",
        fee: 400,
        days: 20,
    ...
    },
    {
        ...
        description: "I'm going to fail this year, I know it. I can't fail! Please, could someone explain about grimoires to me in really simple terms? After that, if they could tell me about the Four Great Spirits, and the... (amended for length) -Parore, Akademy Student",
        rank: 15,
        region: "The Aldanna Range",
        fee: 300,
        days: 20,
    ...
    },
    {
        ...
        description: "Zedlei Forest has been bombed! Looking for a clan to rid our woods of an infestation of bombs! With auction season upon us, who doesn't want a few more clan points in the bank? -Society for Woodland Preservation",
        rank: 14,
    ...
    },
    {
        ...
        description: "I've been reading some old theses of late, and was intrigued by mention of the Ultimate Book of Magick. I know its very existence may only be a legend, still, if you have any information I would be most eager to hear it. -Terad, Magickal Historian",
        rank: 18,
        region: "The Aldanna Range",
        fee: 300,
        days: 20,
    ...
    enemies: [],
        strategy: [            "Cumulative donation rewards unlock at 10000 Gil intervals from Elixir through Ribbon, with Ribbon at 80000 Gil.",
        ],
        rewards: {
            gil: 0,
            cp: 0,
    ...
    },
    {
        ...
        description: "Tis the season: zingu pearl season in the Galleria Deep! All those who wish to go pearl hunting must register by accepting this quest. WARNING: Unregistered pearl hunters will be caught and tried as poachers. -Galleria Jewelers",
        rank: 17,
        region: "The Galleria Deep",
        fee: 300,
        days: undefined,
