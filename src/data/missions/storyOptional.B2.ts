...
export const OPTIONAL_MISSIONS_B2: Mission[] = [
    ...
    },
    {
        ...
        description: "Tis the season: zingu pearl season in the Galleria Deep! All those who wish to go pearl hunting must register by accepting this quest. WARNING: Unregistered pearl hunters will be considered poachers. Galleria Pearl Divers' Association",
        rank: 17,
        region: "The Galleria Deep",
        fee: 300,
        days: undefined,
