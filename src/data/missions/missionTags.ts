...
export const MISSION_TAGS: Record<string, MissionTag[]> = {
    ...
    // =========================
    "ME-01": ["optional", "map-event", "chain", "story-cameo"], // The Search
    "ME-02": ["optional", "map-event", "chain", "recruit", "story-cameo"], // An Elegant Encounter
    "ME-04": ["optional", "map-event", "chain", "recruit", "protection", "story-cameo"], // Where Could He Be?
    "ME-05": ["optional", "map-event", "chain", "story-cameo"], // A Moment's Respite
    "ME-06": ["optional", "map-event", "recruit", "story-cameo"], // A Refined Recruit
    "ME-07": ["optional", "map-event", "chain", "story-cameo"], // I'm Back, Kupo!
    "ME-08": ["optional", "map-event", "chain", "law-sensitive", "missable"], // Making Music map event
    "ME-09": ["optional", "map-event", "chain", "boss", "law-sensitive"], // I Got A Bad Feeling
    "ME-10": ["optional", "map-event", "law-sensitive"], // A Bewitching Encounter
    "ME-11": ["optional", "map-event", "law-sensitive"], // A Hard Place
    "ME-12": ["optional", "map-event", "law-sensitive"], // Burning Soul
    "ME-13": ["optional", "map-event", "postgame", "law-sensitive"], // Dire Rotundity
    "ME-14": ["optional", "map-event", "law-sensitive"], // Fey Mischief
    "ME-15": ["optional", "map-event", "law-sensitive"], // Formidable Strength
    "ME-16": ["optional", "map-event", "law-sensitive"], // Just Desserts
    "ME-17": ["optional", "map-event", "law-sensitive"], // One-Eyed Evil
    "ME-18": ["optional", "map-event", "law-sensitive"], // Open Wide
    "ME-19": ["optional", "map-event", "law-sensitive"], // Otherworldly Visitors
    "ME-20": ["optional", "map-event", "law-sensitive"], // Spirits of Nazan
    "ME-21": ["optional", "map-event", "law-sensitive", "treasure"], // The Strength of the Wolf
    "ME-22": ["optional", "map-event", "law-sensitive"], // Wee Evil
    "ME-23": ["optional", "map-event", "postgame", "treasure", "law-sensitive"], // Of a Feather
    "ME-24": ["optional", "map-event", "law-sensitive", "treasure"], // Graszton Seaways
    "ME-25": ["optional", "map-event", "auction", "chain", "treasure", "law-sensitive"], // House Bowen map event
    "ME-26": ["optional", "map-event", "auction", "law-sensitive"], // Jytras Pirata
    "ME-27": ["optional", "map-event", "law-sensitive"], // Kthili Surveyors
    "ME-28": ["optional", "map-event", "auction", "law-sensitive"], // Moogle Porters
    "ME-29": ["optional", "map-event", "auction", "law-sensitive"], // The Camoa Braves
    "ME-30": ["optional", "map-event", "boss", "law-sensitive"], // The Veluga Pirates
    "ME-31": ["optional", "map-event", "auction", "law-sensitive"], // Chita's Weaponers
    "ME-32": ["optional", "map-event", "auction", "law-sensitive"], // Prima Donna
    "ME-33": ["optional", "map-event", "chain", "law-sensitive"], // With a Smile
    "ME-34": ["optional", "map-event", "auction", "law-sensitive"], // Zedlei Consortium
    "ME-35": ["optional", "map-event", "collection"], // Seeker of Slaughter
    "ME-36": ["optional", "map-event"], // Detitlement
    "ME-37": ["optional", "map-event", "auction", "treasure"], // Champ's Reward - Moorabella
    "ME-38": ["optional", "map-event", "auction", "treasure"], // Master's Reward - Graszton
    "ME-39": ["optional", "map-event", "auction", "treasure"], // Master's Reward - Camoa
    "ME-40": ["optional", "map-event", "auction", "treasure"], // Master's Reward - Moorabella
    "ME-41": ["optional", "map-event", "auction", "treasure"], // Master's Reward - Fluorgis
