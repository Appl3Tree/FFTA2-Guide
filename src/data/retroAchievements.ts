...
export const RETRO_ACHIEVEMENTS_BY_MISSION_ID: Record<string, RetroAchievement[]> = {
    ...
    "A1-06": [
        {
            id: "ra-paw-clear",
            name: "A Paw Full of Feather's",
            description: "Clear Story Mission \"A Paw Full of Feather's\"",
        },
        {
            id: "ra-kamikaze-cid",
            name: "Kamikaze Cid",
            description: "During \"A Paw Full of Feather's\" Defeat all enemies without Cid taking damage 3 times",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "A1-11": [
        ...
        },
        {
            ...
            description: "During \"Yellow Wings\" don't let a unit die",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "A1-16": [
        ...
        },
        {
            id: "ra-tomato-paste",
            name: "Tomato Paste",
            description: "During \"You Say Tomato\" Kill all the \"Deadly Nightshade\" before the \"Alraune\"",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "B2-01": [
        ...
        },
        {
            id: "ra-turtle-power",
            name: "Turtle Power",
            description: "During \"Wanted: Ugohr!\" Kill all the enemies before \"Ugohr\"",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "B2-06": [
        ...
        },
        {
            id: "ra-dragon-force",
            name: "Dragon Force",
            description: "During \"Wanted: Gilmunto!\" Kill all the enemies before \"Gilmunto\"",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "B2-11": [
        ...
        },
        {
            ...
            name: "Sleeping Death",
            description: "During \"Now That's a Fire!\" Defeat all enemies without any member getting Poisoned",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "B2-16": [
        ...
        },
        {
            id: "ra-sandstorm",
            name: "Sandstorm",
            description: "During \"Pearls in the Deep\" Defeat \"Flowsand Lord\" while only attacking him while there are 2 \"Pit Beasts\" alive",
            missable: true,
        },
        // NEW: Hard variant
        {
    ...
    "C3-01": [
        ...
        },
        {
            ...
            description: "During \"Mountain Watch\" Defeat \"Ewen\" with him only getting 1 turn",
            missable: true,
        },
        // NEW
        {
    ...
    "C3-06": [
        ...
        },
        {
            ...
            description: "During \"Grounded! Beat the Mission without breaking the law",
            missable: true,
        },
        // NEW
        {
    ...
    "D4-01": [
        ...
        },
        {
            ...
            description: "During \"Making Music\" Clear the Mission before the Ranger Places 2 traps",
            missable: true,
        },
        // NEW
        {
    ...
    "D4-06": [
        ...
        },
        {
            ...
            name: "Slow & Steady",
            description: "During \"Seeking the Stone\" don't let any of your characters take more than 2 steps in a single turn",
            missable: true,
        },
        // NEW
        {
    ...
    "D4-11": [
        ...
        },
        {
            id: "ra-one-on-one",
            name: "One on One",
            description: "During \"Wanted: Sky Pirate Vaan\" Don't hit more than once in a turn",
            missable: true,
        },
        // NEW
        {
    ...
    "D4-16": [
        ...
        },
        {
            ...
            description: "During \"A Request\" Trigger the explosion 4 times before defeating \"Neukhia\"",
            missable: true,
        },
        // NEW
        {
    ...
    "E5-01": [
        ...
        },
        {
            ...
            description: "During \"The Dig\" Don't use any Fire, Ice or Lightning Attacks_Spells_Weapons",
            missable: true,
        },
        // NEW
        {
    ...
    "E5-06": [
        ...
        },
        {
            ...
            description: "During \"Through Another's Eyes\" Clear the Mission & don't use Ranged Weapons",
            missable: true,
        },
        // NEW
        {
    ...
    "E5-11": [
        ...
        },
        {
            ...
            description: "During \"Pirate Problems\" Defeat \"Vaan?\" in 3 Hits or Less",
            missable: true,
        },
        // NEW
        {
    ...
    "E5-16": [
        ...
        },
        {
            id: "ra-my-judge",
            name: "My Judge!",
            description: "During \"The Ritual\" Uphold the Law & don't let \"Illua\" dismiss the Judge",
            missable: true,
        },
        // NEW
        {
    ...
    "EX-01": [
        ...
        },
        {
            id: "ra-the-end",
            name: "The End?",
            description: "During \"The Two Grimoires\" Defeat \"Illua\" while Upholding the Law & Collecting the chest",
            missable: true,
        },
        // NEW
        {
    ...
    "EX-02": [
        ...
        },
        {
            ...
            name: "All or Nothing",
            description: "During \"From the Rift\" Kill all 3 Parts of \"Neukhia\"",
            missable: true,
        },
        // NEW
        {
    ...
    "C4-14": [
        {
            id: "ra-cat-burglar",
            name: "Cat Burglar",
            description: "During \"The Cat's Meow\" Obtain both Treasure Chests while avoiding all the traps",
            missable: true,
        },
        {
            id: "ra-black-and-white",
            name: "Black & White",
            description: "Unlocked \"Seers\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-06": [
        {
            ...
            description: "Complete Quest \"Of Kupos and Cannons\" without Harming a Moogle",
            missable: true,
        },
        {
            id: "ra-firing-practice",
            name: "Firing Practice",
            description: "Unlocked \"Flintlock\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "B4-04": [
        {
            id: "ra-fire-away",
            name: "Fire Away!",
            description: "During \"The Goug Consortium\" Clear all enemies without exceeding 60 tiles moved across all enemy & ally units",
            missable: true,
        },
        {
            id: "ra-under-fire",
            name: "Under Fire!",
            description: "Unlocked \"Fusilier\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C3-14": [
        {
            id: "ra-four-x-four",
            name: "Four x Four",
            description: "During \"Green Dominion\" Defeat All 4 \"Green Mages\" Before any of them take their 4th Turn",
            missable: true,
        },
        {
            id: "ra-rumble-in-the-jungle",
            name: "Rumble in the Jungle",
            description: "Unlocked \"Green Mage\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C3-13": [
        {
            id: "ra-jump",
            name: "Jump!",
            description: "During \"Kyrra, Dragoon\" Every enemy must be killed by \"Kyrra\"",
            missable: true,
        },
        {
            id: "ra-class-fit-for-a-plumber",
            name: "Class Fit for a Plumber",
            description: "Unlocked \"Dragoon\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-10": [
        {
            ...
            description: "During \"Sleight of Hand\" Do Not Harm an Enemy before you take all the Treasure Chests",
            missable: true,
        },
        {
            id: "ra-trick-room",
            name: "Trick Room",
            description: "Unlocked \"Trickster\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-05": [
        {
            id: "ra-living-dead",
            name: "Living Dead",
            description: "During Battle 3 of \"Popocho's Chocobos\" Defeat all enemies without \"Ghost\" Reviving",
            missable: true,
        },
        {
            id: "ra-knight-of-the-yellow-feather",
            name: "Knight of the Yellow Feather",
            description: "Unlocked \"Chocobo Knight\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-07": [
        {
            ...
            description: "During \"Instrument of Inspiration\" Clear the Mission without both \"Devotee's\" Dying",
            missable: true,
        },
        {
            id: "ra-blue",
            name: "Blue",
            description: "Unlocked \"Raptor\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-13": [
        {
            id: "ra-no-freebies",
            name: "No Freebies",
            description: "During \"Banbanga!\" Defeat all Enemies without using any items",
            missable: true,
        },
        {
            id: "ra-master-sabin",
            name: "Master Sabin",
            description: "Unlocked \"Master Monk\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "B4-12": [
        {
            id: "ra-rune-fencer",
            name: "Rune Fencer",
            description: "During \"To Be a Spellblade\" Don't let Hana's HP go below 100",
            missable: true,
        },
        {
            id: "ra-sword-mage",
            name: "Sword Mage",
            description: "Unlocked \"The Spellblade\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C5-06": [
        {
            ...
            description: "During \"A Lanista's Pride\" Kill all enemies within 10 minutes (Timer Starts at Battle Start)",
            missable: true,
        },
        {
            id: "ra-eye-for-an-eye",
            name: "Eye For An Eye",
            description: "Unlocked \"Lanista\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C5-05": [
        {
            ...
            description: "During \"Ravager\" Beat the Mission while not targeting anyone or anything that isn't next to you",
            missable: true,
        },
        {
            id: "ra-final-strike",
            name: "Final Strike!",
            description: "Unlocked \"Ravager\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-01": [
        {
            ...
            description: "During \"Veis, Assassin\" Defeat \"Nlogax\" Without Veis doing any damage",
            missable: true,
        },
        {
            id: "ra-silent-but-deadly",
            name: "Silent But Deadly",
            description: "Unlocked \"Assassin\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "B3-16": [
        {
            id: "ra-stand-guard",
            name: "Stand Guard",
            description: "During \"Knowing the Beast\" Successfully hold out for 4 Rounds with only 2 Party Members placed on the field.",
            missable: true,
        },
        {
            id: "ra-monster-tamer",
            name: "Monster Tamer",
            description: "Unlocked \"Beastmaster\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "B4-08": [
        {
            id: "ra-juggernaut",
            name: "Juggernaut",
            description: "During \"The Eastwatch\" Kill all enemies without healing or having a unit die",
            missable: true,
        },
        {
            id: "ra-bodyguard",
            name: "Bodyguard",
            description: "Unlocked \"Parivir\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "B4-16": [
        {
            id: "ra-hard-hitter",
            name: "Hard Hitter",
            description: "During \"Lord Grayrl!\" Defeat \"Lord Grayrl\" in 5 hits or less (Double Hit Attacks & Dual Cast Count as 2)",
            missable: true,
        },
        {
            id: "ra-til-valhalla",
            name: "Til Valhalla!",
            description: "Unlocked \"Viking\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "B5-08": [
        {
            id: "ra-shields-up",
            name: "Shields Up!",
            description: "During \"Geomancer's Way - Mist\" Do Not let any unit fall under 100 HP",
            missable: true,
        },
        {
            id: "ra-weather-man",
            name: "Weather Man",
            description: "Unlocked \"Geomancer\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-02": [
        {
            id: "ra-spikey-demise",
            name: "Spikey Demise",
            description: "During \"To Be A Fighter\" Clear the level without laying or triggering any traps on your turn",
            missable: true,
        },
        {
            id: "ra-fight-club",
            name: "Fight Club",
            description: "Unlocked \"Fighter\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C1-12": [
        {
            ...
            description: "Unlocked \"Arcanist\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C1-15": [
        {
            ...
            description: "Unlocked \"Cannoneer\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "C4-09": [
        {
            id: "ra-textbook",
            name: "Textbook",
            description: "Unlocked \"Scholar\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
    "E5-15": [
    ...
    "EX-03": [
        {
            id: "ra-the-gifted",
            name: "The Gifted",
            description: "Unlocked \"Heritor\" Class",
            category: "Advanced Jobs & Recruits",
        },
    ],
};
...
export const GLOBAL_RETRO_ACHIEVEMENTS: GlobalRetroAchievement[] = [
    // Quest completion grids
    {
        ...
        description: "Complete all quests in the \"1-A\" grid",
        notes: "App quest group: A1-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-ii",
        name: "Completionist II",
        description: "Complete all quests in the \"1-B\" grid",
        notes: "App quest group: B1-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-iii",
        name: "Completionist III",
        description: "Complete all quests in the \"1-C\" grid",
        notes: "App quest group: C1-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-iv",
        name: "Completionist IV",
        description: "Complete all quests in the \"1-D\" grid",
        notes: "App quest group: D1-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-v",
        name: "Completionist V",
        description: "Complete all quests in the \"1-E\" grid",
        notes: "App quest group: E1-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-vi",
        name: "Completionist VI",
        description: "Complete all quests in the \"2-A\" grid",
        notes: "App quest group: A2-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-vii",
        name: "Completionist VII",
        description: "Complete all quests in the \"2-B\" grid",
        notes: "App quest group: B2-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-viii",
        name: "Completionist VIII",
        description: "Complete all quests in the \"2-C\" grid",
        notes: "App quest group: C2-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-ix",
        name: "Completionist IX",
        description: "Complete all quests in the \"2-D\" grid",
        notes: "App quest group: D2-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-x",
        name: "Completionist X",
        description: "Complete all quests in the \"2-E\" grid",
        notes: "App quest group: E2-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xi",
        name: "Completionist XI",
        description: "Complete all quests in the \"3-A\" grid",
        notes: "App quest group: A3-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xii",
        name: "Completionist XII",
        description: "Complete all quests in the \"3-B\" grid",
        notes: "App quest group: B3-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xiii",
        name: "Completionist XIII",
        description: "Complete all quests in the \"3-C\" grid",
        notes: "App quest group: C3-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xiv",
        name: "Completionist XIV",
        description: "Complete all quests in the \"3-D\" grid",
        notes: "App quest group: D3-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xv",
        name: "Completionist XV",
        description: "Complete all quests in the \"3-E\" grid",
        notes: "App quest group: E3-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xvi",
        name: "Completionist XVI",
        description: "Complete all quests in the \"4-A\" grid",
        notes: "App quest group: A4-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xvii",
        name: "Completionist XVII",
        description: "Complete all quests in the \"4-B\" grid",
        notes: "App quest group: B4-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xviii",
        name: "Completionist XVIII",
        description: "Complete all quests in the \"4-C\" grid",
        notes: "App quest group: C4-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xix",
        name: "Completionist XIX",
        description: "Complete all quests in the \"4-D\" grid",
        notes: "App quest group: D4-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xx",
        name: "Completionist XX",
        description: "Complete all quests in the \"4-E\" grid",
        notes: "App quest group: E4-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xxi",
        name: "Completionist XXI",
        description: "Complete all quests in the \"5-A\" grid",
        notes: "App quest group: A5-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xxii",
        name: "Completionist XXII",
        description: "Complete all quests in the \"5-B\" grid",
        notes: "App quest group: B5-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xxiii",
        name: "Completionist XXIII",
        description: "Complete all quests in the \"5-C\" grid",
        notes: "App quest group: C5-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xxiv",
        name: "Completionist XXIV",
        description: "Complete all quests in the \"5-D\" grid",
        notes: "App quest group: D5-*.",
        category: "Quest Completion Grids",
    },
    {
        id: "ra-completionist-xxv",
        name: "Completionist XXV",
        description: "Complete all quests in the \"5-E\" grid (MUST CLEAR FINAL BOSS AGAIN ONCE COMPLETE)",
        notes: "App quest group: E5-*.",
        category: "Quest Completion Grids",
    },
    ...
    // Level milestones
    {
        id: "ra-leveled-i",
        name: "Leveled I",
        description: "Have any unit level up to 25 (Recruiting 25+ Doesn't Count)",
        category: "Level Milestones",
    },
    {
        id: "ra-leveled-ii",
        name: "Leveled II",
        description: "Have any unit level up to 50 (Recruiting 50+ Doesn't Count)",
        category: "Level Milestones",
    },
    {
        id: "ra-leveled-iii",
        name: "Leveled III",
        description: "Have any unit level up to 99 (Recruiting 99 Doesn't Count)",
        category: "Level Milestones",
    },
    ...
    // Auctions & tokens
    {
        ...
        name: "Token Emporium",
        description: "Obtain the Reward for \"Played\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-fancy-pants",
        name: "Fancy Pants",
        description: "Obtain the Reward for \"Bonuses\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-region-master",
        name: "Region Master",
        description: "Obtain the Reward for \"1st\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-runner-up",
        name: "Runner Up",
        description: "Obtain the Reward for \"2nd\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-might-as-well-be-last",
        name: "Might As Well Be Last",
        description: "Obtain the Reward for \"3rd\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-tokens-small",
        name: "Tokens Small",
        description: "Obtain the Reward for \"1-Coin Tokens\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-tokens-medium",
        name: "Tokens Medium",
        description: "Obtain the Reward for \"2-Coin Tokens\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-tokens-large",
        name: "Tokens Large",
        description: "Obtain the Reward for \"3-Coin Tokens\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-tokens-xtra",
        name: "Tokens Xtra",
        description: "Obtain the Reward for \"5-Coin Tokens\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-you-shall-pass",
        name: "You Shall Pass",
        description: "Obtain the Reward for \"Passes\" in Auction's",
        category: "Auctions & Tokens",
    },
    {
        id: "ra-hoarder",
    ...
    },
    {
        id: "ra-motherlode",
        name: "Motherlode",
        description: "Win an Auction Round by spending 30+ coins",
        category: "Auctions & Tokens",
    },
    {
    ...
    },
    {
        ...
        description: "Obtain all the Scion's (Except Shemhazai)",
        category: "Scions & Brightmoon Tor",
    },
    {
        id: "ra-red-demon",
    ...
    },
    {
        id: "ra-bloody-tears",
        name: "Bloody Tears",
        description: "Obtain \"Crimson Tear\"",
        category: "Scions & Brightmoon Tor",
    },
    {
    ...
    },
    {
        id: "ra-law-man",
        name: "Law Man",
        description: "Obtain 50% of the Laws in the Game",
        category: "Laws & Records",
    },
    {
        id: "ra-law-maker",
    ...
    // Notices & rumors
    {
        id: "ra-notice-board",
        name: "Notice Board",
        description: "Read 50% of \" Notices\"",
        category: "Notices & Rumors",
    },
    {
        id: "ra-noticed-it-all",
        name: "Noticed It All!",
        description: "Read all \"Notices\"",
        category: "Notices & Rumors",
    },
    {
        id: "ra-have-you-heard",
        name: "Have You Heard?",
        description: "Read 50% of \"Rumors\"",
        category: "Notices & Rumors",
    },
    {
        id: "ra-heard-it-all",
        name: "Heard It All!",
        description: "Read all the \"Rumors\"",
        category: "Notices & Rumors",
    },
    ...
    // Clan growth (trials, privileges, talents)
    {
        id: "ra-trials",
        name: "Trials",
        description: "Complete all \"Clan Trials\" Once",
    ...
    },
    {
        ...
        name: "Talented Bunch",
        description: "Max out \"Clan Talents\"",
        category: "Clan Growth",
    },
    ...
    // Crafting
    {
        id: "ra-apprentice",
        name: "Apprentice",
        description: "Craft your first (B) Rank",
        category: "Crafting",
    },
    {
        id: "ra-hobbyist",
        name: "Hobbyist",
        description: "Craft your first (A) Rank",
        category: "Crafting",
    },
    {
        id: "ra-master-crafter",
        name: "Master Crafter",
        description: "In a single visit to the Bazaar, Craft 5 (A) Rank Pieces of Gear",
        category: "Crafting",
    },
